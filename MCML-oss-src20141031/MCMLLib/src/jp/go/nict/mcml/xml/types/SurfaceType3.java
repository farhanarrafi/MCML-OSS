...
public class SurfaceType3 extends jp.go.nict.mcml.xml.altova.xml.Node {
	public SurfaceType3() {
		super();
	}

	public SurfaceType3(SurfaceType3 node) {
		super(node);
	}

	public SurfaceType3(org.w3c.dom.Node node) {
		super(node);
	}

	public SurfaceType3(org.w3c.dom.Document doc) {
		super(doc);
	}
