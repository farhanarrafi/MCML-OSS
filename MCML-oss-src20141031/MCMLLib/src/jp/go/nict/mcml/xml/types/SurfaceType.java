...
public class SurfaceType extends jp.go.nict.mcml.xml.altova.xml.Node {
	public SurfaceType() {
		super();
	}

	public SurfaceType(SurfaceType node) {
		super(node);
	}

	public SurfaceType(org.w3c.dom.Node node) {
		super(node);
	}

	public SurfaceType(org.w3c.dom.Document doc) {
		super(doc);
	}
