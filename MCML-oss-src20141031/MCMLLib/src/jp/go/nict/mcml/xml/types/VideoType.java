...
public class VideoType extends jp.go.nict.mcml.xml.altova.xml.Node {
	public VideoType() {
		super();
	}

	public VideoType(VideoType node) {
		super(node);
	}

	public VideoType(org.w3c.dom.Node node) {
		super(node);
	}

	public VideoType(org.w3c.dom.Document doc) {
		super(doc);
	}
