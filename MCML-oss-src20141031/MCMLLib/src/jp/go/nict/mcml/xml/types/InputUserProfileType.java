...
public class InputUserProfileType extends jp.go.nict.mcml.xml.altova.xml.Node {
	public InputUserProfileType() {
		super();
	}

	public InputUserProfileType(InputUserProfileType node) {
		super(node);
	}

	public InputUserProfileType(org.w3c.dom.Node node) {
		super(node);
	}

	public InputUserProfileType(org.w3c.dom.Document doc) {
		super(doc);
	}
	public void adjustPrefix() {
		...
		count = getDomChildCount(Element, null, "InputModality");
		for (int i = 0; i < count; i++) {
			org.w3c.dom.Node tmpNode = getDomChildAt(Element, null, "InputModality", i);
			internalAdjustPrefix(tmpNode, true);
			new InputModalityType(tmpNode).adjustPrefix();
		}
	}
	...
	public int getInputModalityMinCount() {
		return 0;
	}

	public int getInputModalityMaxCount() {
		return 1;
	}

	public int getInputModalityCount() {
		return getDomChildCount(Element, null, "InputModality");
	}

	public boolean hasInputModality() {
		return hasDomChild(Element, null, "InputModality");
	}

	public InputModalityType getInputModalityAt(int index) throws Exception {
		return new InputModalityType(getDomChildAt(Element, null, "InputModality", index));
	}

	public InputModalityType getInputModality() throws Exception {
		return getInputModalityAt(0);
	}

	public void removeInputModalityAt(int index) {
		removeDomChildAt(Element, null, "InputModality", index);
	}

	public void removeInputModality() {
		while (hasInputModality())
			removeInputModalityAt(0);
	}

	public void addInputModality(InputModalityType value) {
		appendDomElement(null, "InputModality", value);
	}

	public void insertInputModalityAt(InputModalityType value, int index) {
		insertDomElementAt(null, "InputModality", index, value);
	}

	public void replaceInputModalityAt(InputModalityType value, int index) {
		replaceDomElementAt(null, "InputModality", index, value);
	}
}
