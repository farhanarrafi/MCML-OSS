...
public class OutputType extends jp.go.nict.mcml.xml.altova.xml.Node {
	public OutputType() {
		super();
	}

	public OutputType(OutputType node) {
		super(node);
	}

	public OutputType(org.w3c.dom.Node node) {
		super(node);
	}

	public OutputType(org.w3c.dom.Document doc) {
		super(doc);
	}
