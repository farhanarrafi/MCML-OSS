...
public class TransmitterType extends jp.go.nict.mcml.xml.altova.xml.Node {
	public TransmitterType() {
		super();
	}

	public TransmitterType(TransmitterType node) {
		super(node);
	}

	public TransmitterType(org.w3c.dom.Node node) {
		super(node);
	}

	public TransmitterType(org.w3c.dom.Document doc) {
		super(doc);
	}
