...
public class POSType extends jp.go.nict.mcml.xml.altova.xml.Node {
	public POSType() {
		super();
	}

	public POSType(POSType node) {
		super(node);
	}

	public POSType(org.w3c.dom.Node node) {
		super(node);
	}

	public POSType(org.w3c.dom.Document doc) {
		super(doc);
	}
