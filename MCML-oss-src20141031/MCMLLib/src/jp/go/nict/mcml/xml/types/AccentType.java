...
public class AccentType extends jp.go.nict.mcml.xml.altova.xml.Node {
	public AccentType() {
		super();
	}

	public AccentType(AccentType node) {
		super(node);
	}

	public AccentType(org.w3c.dom.Node node) {
		super(node);
	}

	public AccentType(org.w3c.dom.Document doc) {
		super(doc);
	}
