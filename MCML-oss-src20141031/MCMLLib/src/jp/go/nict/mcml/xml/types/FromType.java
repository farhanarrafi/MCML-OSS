...
public class FromType extends jp.go.nict.mcml.xml.altova.xml.Node {
	public FromType() {
		super();
	}

	public FromType(FromType node) {
		super(node);
	}

	public FromType(org.w3c.dom.Node node) {
		super(node);
	}

	public FromType(org.w3c.dom.Document doc) {
		super(doc);
	}
