...
public class WritingType extends jp.go.nict.mcml.xml.altova.xml.Node {
	public WritingType() {
		super();
	}

	public WritingType(WritingType node) {
		super(node);
	}

	public WritingType(org.w3c.dom.Node node) {
		super(node);
	}

	public WritingType(org.w3c.dom.Document doc) {
		super(doc);
	}
