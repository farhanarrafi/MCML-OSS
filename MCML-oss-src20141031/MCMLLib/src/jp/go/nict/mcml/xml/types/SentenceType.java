...
public class SentenceType extends jp.go.nict.mcml.xml.altova.xml.Node {
	public SentenceType() {
		super();
	}

	public SentenceType(SentenceType node) {
		super(node);
	}

	public SentenceType(org.w3c.dom.Node node) {
		super(node);
	}

	public SentenceType(org.w3c.dom.Document doc) {
		super(doc);
	}
	public void adjustPrefix() {
		...
		count = getDomChildCount(Element, null, "Function");
		for (int i = 0; i < count; i++) {
			org.w3c.dom.Node tmpNode = getDomChildAt(Element, null, "Function", i);
		...
		for (int i = 0; i < count; i++) {
			...
			internalAdjustPrefix(tmpNode, true);
			new SurfaceType2(tmpNode).adjustPrefix();
		}
		count = getDomChildCount(Element, null, "Chunk");
		for (int i = 0; i < count; i++) {
			org.w3c.dom.Node tmpNode = getDomChildAt(Element, null, "Chunk", i);
			internalAdjustPrefix(tmpNode, true);
			new ChunkType(tmpNode).adjustPrefix();
		}
	}
	...
	public int getFunctionMinCount() {
		return 0;
	}

	public int getFunctionMaxCount() {
		return Integer.MAX_VALUE;
	}

	public int getFunctionCount() {
		return getDomChildCount(Element, null, "Function");
	}

	public boolean hasFunction() {
		return hasDomChild(Element, null, "Function");
	}

	public SchemaString getFunctionAt(int index) throws Exception {
		return new SchemaString(getDomNodeValue(getDomChildAt(Element, null, "Function", index)));
	}

	public SchemaString getFunction() throws Exception {
		return getFunctionAt(0);
	}

	public void removeFunctionAt(int index) {
		removeDomChildAt(Element, null, "Function", index);
	}
	...
	public void addFunction(SchemaString value) {
		appendDomChild(Element, null, "Function", value.toString());
	}

	public void addFunction(String value) throws Exception {
		addFunction(new SchemaString(value));
	}

	public void insertFunctionAt(SchemaString value, int index) {
		insertDomChildAt(Element, null, "Function", index, value.toString());
	}

	public void insertFunctionAt(String value, int index) throws Exception {
		insertFunctionAt(new SchemaString(value), index);
	}

	public void replaceFunctionAt(SchemaString value, int index) {
		replaceDomChildAt(Element, null, "Function", index, value.toString());
	}

	public void replaceFunctionAt(String value, int index) throws Exception {
		replaceFunctionAt(new SchemaString(value), index);
	}
	...
	public SurfaceType2 getSurfaceAt(int index) throws Exception {
		return new SurfaceType2(getDomChildAt(Element, null, "Surface", index));
	}

	public SurfaceType2 getSurface() throws Exception {
	...
	public void addSurface(SurfaceType2 value) {
		appendDomElement(null, "Surface", value);
	}

	public void insertSurfaceAt(SurfaceType2 value, int index) {
		insertDomElementAt(null, "Surface", index, value);
	}

	public void replaceSurfaceAt(SurfaceType2 value, int index) {
		replaceDomElementAt(null, "Surface", index, value);
	}

	public int getChunkMinCount() {
		return 0;
	}
	...
	public int getChunkCount() {
		return getDomChildCount(Element, null, "Chunk");
	}

	public boolean hasChunk() {
		return hasDomChild(Element, null, "Chunk");
	}

	public ChunkType getChunkAt(int index) throws Exception {
		return new ChunkType(getDomChildAt(Element, null, "Chunk", index));
	}

	public ChunkType getChunk() throws Exception {
		return getChunkAt(0);
	}

	public void removeChunkAt(int index) {
		removeDomChildAt(Element, null, "Chunk", index);
	}
	...
	public void addChunk(ChunkType value) {
		appendDomElement(null, "Chunk", value);
	}

	public void insertChunkAt(ChunkType value, int index) {
		insertDomElementAt(null, "Chunk", index, value);
	}

	public void replaceChunkAt(ChunkType value, int index) {
		replaceDomElementAt(null, "Chunk", index, value);
	}
}
