...
public class paragraph extends jp.go.nict.ssml.xml.altova.xml.Node {
	public paragraph() {
		super();
	}

	public paragraph(paragraph node) {
		super(node);
	}

	public paragraph(org.w3c.dom.Node node) {
		super(node);
	}

	public paragraph(org.w3c.dom.Document doc) {
		super(doc);
	}
