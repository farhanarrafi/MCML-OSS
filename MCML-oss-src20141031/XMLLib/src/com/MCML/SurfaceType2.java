...
public class SurfaceType2 extends com.MCML.xs.stringType
{
	public static com.altova.xml.meta.ComplexType getStaticInfo() { return new com.altova.xml.meta.ComplexType(com.MCML.MCML_TypeInfo.binder.getTypes()[com.MCML.MCML_TypeInfo._altova_ti_altova_SurfaceType2]); }
	
	public SurfaceType2(org.w3c.dom.Node init)
	{
		super(init);
		instantiateMembers();
	}
	...
	{
		Delimiter = new MemberAttribute_Delimiter (this, com.MCML.MCML_TypeInfo.binder.getMembers()[com.MCML.MCML_TypeInfo._altova_mi_altova_SurfaceType2._Delimiter]);

	}
	// Attributes
	public MemberAttribute_Delimiter Delimiter;
		public static class MemberAttribute_Delimiter
		{
			private com.altova.xml.TypeBase owner;
			private com.altova.typeinfo.MemberInfo info; 
			public MemberAttribute_Delimiter (com.altova.xml.TypeBase owner, com.altova.typeinfo.MemberInfo info) {this.owner = owner; this.info = info;}
