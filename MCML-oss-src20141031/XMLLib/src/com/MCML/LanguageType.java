...
public class LanguageType extends com.altova.xml.TypeBase
{
	public static com.altova.xml.meta.ComplexType getStaticInfo() { return new com.altova.xml.meta.ComplexType(com.MCML.MCML_TypeInfo.binder.getTypes()[com.MCML.MCML_TypeInfo._altova_ti_altova_LanguageType]); }
	
	public LanguageType(org.w3c.dom.Node init)
	{
		super(init);
		instantiateMembers();
	}
	...
	{
		ID = new MemberAttribute_ID (this, com.MCML.MCML_TypeInfo.binder.getMembers()[com.MCML.MCML_TypeInfo._altova_mi_altova_LanguageType._ID]);
		Dialect = new MemberAttribute_Dialect (this, com.MCML.MCML_TypeInfo.binder.getMembers()[com.MCML.MCML_TypeInfo._altova_mi_altova_LanguageType._Dialect]);
		Fluency = new MemberAttribute_Fluency (this, com.MCML.MCML_TypeInfo.binder.getMembers()[com.MCML.MCML_TypeInfo._altova_mi_altova_LanguageType._Fluency]);
	...
	public MemberAttribute_Fluency Fluency;
		public static class MemberAttribute_Fluency
		{
			private com.altova.xml.TypeBase owner;
			private com.altova.typeinfo.MemberInfo info; 
			public MemberAttribute_Fluency (com.altova.xml.TypeBase owner, com.altova.typeinfo.MemberInfo info) {this.owner = owner; this.info = info;}
			public int getValue() {
